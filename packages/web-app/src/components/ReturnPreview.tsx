...
export const ReturnPreview: React.FC<ReturnPreviewProps> = ({
  transactions,
  quarter,
  year,
}) => {
  ...
  transactions.forEach((tx) => {
    ...
    byCountry[tx.buyerCountry].vatAmount +=
      (tx.amount * (tx.vatRate || 19)) / 100;
    ...
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      ...
      <div className="bg-blue-50 border-b border-gray-200 px-6 py-4">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Sections 2A–2D: Intra-community B2C supplies
        </p>
      </div>
